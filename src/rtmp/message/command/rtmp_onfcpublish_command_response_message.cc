#include "../../../../private/rtmp/message/command/rtmp_onfcpublish_command_response_message.h"
#include "../../../../private/amf/amf.h"
using namespace RtmpKit;

void RtmpOnFCPublishCommandResponseMessage::deserialize(const v8::const_iterator& begin, const v8::const_iterator& end)
{
	auto iter = begin;
...
void RtmpOnFCPublishCommandResponseMessage::deserialize()
{
...
std::size_t RtmpOnFCPublishCommandResponseMessage::size() const
{
	return payloadSize();
}

std::size_t RtmpOnFCPublishCommandResponseMessage::headerSize()
{
	return 12;
}

bool RtmpOnFCPublishCommandResponseMessage::isSuccessfull() const
{
	// TODO (diegostamigni): verify if the get some sort of NetStream.CreateStream.Successfull like with the `connect' command
	return true;
}

std::string RtmpOnFCPublishCommandResponseMessage::description() const
{
