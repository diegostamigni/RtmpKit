#include "../../../../private/rtmp/message/command/rtmp_release_stream_command_message.h"
#include "../../../../private/amf/amf.h"
using namespace RtmpKit;

RtmpReleaseStreamCommandMessage::RtmpReleaseStreamCommandMessage()
	: publishingName_("")
{
	setTransactionID(1);
	setCommandName("releaseStream");
	setType(RtmpMessageType::CommandMessage_AMF0);
}

RtmpReleaseStreamCommandMessage::RtmpReleaseStreamCommandMessage(const std::string& publishingName)
...
const v8& RtmpReleaseStreamCommandMessage::serialize()
{
	payload_.clear();
