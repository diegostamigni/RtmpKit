//
//  rtmp_create_stream_command_response_message.h
//  Diego Stamigni
//
...
namespace RtmpKit
{
	class RtmpCreateStreamCommandResponseMessage : public RtmpCreateStreamCommandMessage, public RtmpCommandMessageResponse
	{
	public:
